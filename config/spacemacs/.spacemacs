...
values."
  (setq-default
   ...
   '(
     ...
     dap
     python
     ;; pip install ptvsd importmagic epc ipython python-language-server pyls-isort pyls-mypy pyls-black flake8
     ;; on my winodws flake8 did not work.
     (python :variables
             python-backend 'lsp
             python-tab-width 4
