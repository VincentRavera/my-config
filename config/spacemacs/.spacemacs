...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  (server-start)
  ;; please add to /etc/profile.d/emacs.bash or your ~/.bashrc and/or ~/.zshrc
  ;; if [[ $INSIDE_EMACS ]]
  ;; then
